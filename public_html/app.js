	...
	*/
	...
	const TodoMenu = (_a) => {
	    ...
	    return (React.createElement("ul", Object.assign({ style: { width: "20vw" }, className: "todo-list list h-resizable ma0 pa0 br b--light-silver-o" }, props),
	        React.createElement(enhancedFlipMove, { leaveAnimation: "accordionVertical", enterAnimation: "accordionVertical", typeName: null }, todos.filter(isTodo).map(todo => (React.createElement("li", { key: todo.id }, children(todo)))))));
	};
